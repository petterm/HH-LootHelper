...
function UI.CreateLootRow()
    ...
    frame.prefix.title:SetPoint("TOPLEFT", frame.prefix, "TOPLEFT", 31, -3)
    ...
    frame.prefix.hrl:SetPoint("TOPLEFT", frame.prefix, "TOPLEFT", 3, 0)
    ...
    frame.prefix.hrr:SetPoint("TOPRIGHT", frame.prefix, "TOPRIGHT", -3, 0)
